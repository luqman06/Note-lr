...
//                int color = this.color;
            ...
            case R.id.delete:
                ...
                alertDialog.setMessage("Kamu Yakin");
                alertDialog.setNegativeButton("YHA", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        presenter.deleteNote(id);
                    }
                });
                alertDialog.setPositiveButton("Tidak", ((dialog, which) -> {
